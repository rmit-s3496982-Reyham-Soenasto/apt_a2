...
#define AVAILABLELEN 3

#define STOCK_LINE_SIZE IDLEN+1+NAMELEN+1+DESCLEN+1+PRICELEN+1+AVAILABLELEN

#define COIN_LINE_SIZE 10

#define DOLLAR_CONVERSION 100

#define MAX_REFUND 10

#define MENU_INPUT_SIZE 2

#define DENOM_PRINT 10

#define ID_FORMAT_SPECIFIER 4
